...
export namespace NatureListRequest$ {
    ...
    export const inboundSchema: z.ZodType<NatureListRequest, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, NatureListRequest> = z
        .object({
            limit: z.number().int().optional(),
            offset: z.number().int().optional(),
        })
...
export namespace NatureListResponseBody$ {
    ...
    export const inboundSchema: z.ZodType<NatureListResponseBody, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, NatureListResponseBody> = z
        .object({
            count: z.number().int().optional(),
            next: z.string().nullable().optional(),
            previous: z.string().nullable().optional(),
...
export namespace NatureListResponse$ {
    ...
    export const inboundSchema: z.ZodType<NatureListResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, NatureListResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
