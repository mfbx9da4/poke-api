...
export namespace MoveDamageClassReadRequest$ {
    ...
    export const inboundSchema: z.ZodType<MoveDamageClassReadRequest, z.ZodTypeDef, Inbound> = z
        .object({
            id: z.number().int(),
        })
        .transform((v) => {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, MoveDamageClassReadRequest> = z
        .object({
            id: z.number().int(),
        })
        .transform((v) => {
...
export namespace MoveDamageClassReadResponse$ {
    ...
    export const inboundSchema: z.ZodType<MoveDamageClassReadResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, MoveDamageClassReadResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
