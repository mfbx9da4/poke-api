...
export namespace EvolutionChainListRequest$ {
    ...
    export const inboundSchema: z.ZodType<EvolutionChainListRequest, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, EvolutionChainListRequest> = z
        .object({
            limit: z.number().int().optional(),
            offset: z.number().int().optional(),
        })
...
export namespace EvolutionChainListResponseBody$ {
    ...
    export const inboundSchema: z.ZodType<EvolutionChainListResponseBody, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, EvolutionChainListResponseBody> =
        z
            .object({
                count: z.number().int().optional(),
                next: z.string().nullable().optional(),
...
export namespace EvolutionChainListResponse$ {
    ...
    export const inboundSchema: z.ZodType<EvolutionChainListResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ContentType: z.string(),
            StatusCode: z.number().int(),
            RawResponse: z.instanceof(Response),
            object: z.lazy(() => EvolutionChainListResponseBody$.inboundSchema).optional(),
        })
        .transform((v) => {
            return {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, EvolutionChainListResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
            ...
            object: z.lazy(() => EvolutionChainListResponseBody$.outboundSchema).optional(),
        })
        .transform((v) => {
            return {
                ContentType: v.contentType,
