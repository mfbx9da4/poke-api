...
export namespace LocationReadRequest$ {
    ...
    export const inboundSchema: z.ZodType<LocationReadRequest, z.ZodTypeDef, Inbound> = z
        .object({
            id: z.number().int(),
        })
        .transform((v) => {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, LocationReadRequest> = z
        .object({
            id: z.number().int(),
        })
        .transform((v) => {
...
export namespace LocationReadResponse$ {
    ...
    export const inboundSchema: z.ZodType<LocationReadResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, LocationReadResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
