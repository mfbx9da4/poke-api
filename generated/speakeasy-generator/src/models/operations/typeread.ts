...
export namespace TypeReadRequest$ {
    ...
    export const inboundSchema: z.ZodType<TypeReadRequest, z.ZodTypeDef, Inbound> = z
        .object({
            id: z.number().int(),
        })
        .transform((v) => {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, TypeReadRequest> = z
        .object({
            id: z.number().int(),
        })
        .transform((v) => {
...
export namespace TypeReadResponse$ {
    ...
    export const inboundSchema: z.ZodType<TypeReadResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, TypeReadResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
