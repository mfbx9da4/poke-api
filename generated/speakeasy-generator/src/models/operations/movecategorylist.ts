...
export namespace MoveCategoryListRequest$ {
    ...
    export const inboundSchema: z.ZodType<MoveCategoryListRequest, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, MoveCategoryListRequest> = z
        .object({
            limit: z.number().int().optional(),
            offset: z.number().int().optional(),
        })
...
export namespace MoveCategoryListResponseBody$ {
    ...
    export const inboundSchema: z.ZodType<MoveCategoryListResponseBody, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, MoveCategoryListResponseBody> = z
        .object({
            count: z.number().int().optional(),
            next: z.string().nullable().optional(),
            previous: z.string().nullable().optional(),
...
export namespace MoveCategoryListResponse$ {
    ...
    export const inboundSchema: z.ZodType<MoveCategoryListResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ContentType: z.string(),
            StatusCode: z.number().int(),
            RawResponse: z.instanceof(Response),
            object: z.lazy(() => MoveCategoryListResponseBody$.inboundSchema).optional(),
        })
        .transform((v) => {
            return {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, MoveCategoryListResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
            ...
            object: z.lazy(() => MoveCategoryListResponseBody$.outboundSchema).optional(),
        })
        .transform((v) => {
            return {
                ContentType: v.contentType,
