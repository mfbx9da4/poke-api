...
export namespace GrowthRateListRequest$ {
    ...
    export const inboundSchema: z.ZodType<GrowthRateListRequest, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GrowthRateListRequest> = z
        .object({
            limit: z.number().int().optional(),
            offset: z.number().int().optional(),
        })
...
export namespace GrowthRateListResponseBody$ {
    ...
    export const inboundSchema: z.ZodType<GrowthRateListResponseBody, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GrowthRateListResponseBody> = z
        .object({
            count: z.number().int().optional(),
            next: z.string().nullable().optional(),
            previous: z.string().nullable().optional(),
...
export namespace GrowthRateListResponse$ {
    ...
    export const inboundSchema: z.ZodType<GrowthRateListResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ContentType: z.string(),
            StatusCode: z.number().int(),
            RawResponse: z.instanceof(Response),
            object: z.lazy(() => GrowthRateListResponseBody$.inboundSchema).optional(),
        })
        .transform((v) => {
            return {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GrowthRateListResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
            ...
            object: z.lazy(() => GrowthRateListResponseBody$.outboundSchema).optional(),
        })
        .transform((v) => {
            return {
                ContentType: v.contentType,
