...
export namespace BerryFirmnessListRequest$ {
    ...
    export const inboundSchema: z.ZodType<BerryFirmnessListRequest, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, BerryFirmnessListRequest> = z
        .object({
            limit: z.number().int().optional(),
            offset: z.number().int().optional(),
        })
...
export namespace BerryFirmnessListResponseBody$ {
    ...
    export const inboundSchema: z.ZodType<BerryFirmnessListResponseBody, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, BerryFirmnessListResponseBody> =
        z
            .object({
                count: z.number().int().optional(),
                next: z.string().nullable().optional(),
...
export namespace BerryFirmnessListResponse$ {
    ...
    export const inboundSchema: z.ZodType<BerryFirmnessListResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ContentType: z.string(),
            StatusCode: z.number().int(),
            RawResponse: z.instanceof(Response),
            object: z.lazy(() => BerryFirmnessListResponseBody$.inboundSchema).optional(),
        })
        .transform((v) => {
            return {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, BerryFirmnessListResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
            ...
            object: z.lazy(() => BerryFirmnessListResponseBody$.outboundSchema).optional(),
        })
        .transform((v) => {
            return {
                ContentType: v.contentType,
