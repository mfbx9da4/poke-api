...
export namespace EncounterConditionValueReadResponse$ {
  export type Inbound = {
    ...
    EncounterConditionValue?:
      | components.EncounterConditionValue$.Inbound
      | undefined;
  };
  ...
  > = z
    .object({
      ...
      EncounterConditionValue:
        components.EncounterConditionValue$.inboundSchema.optional(),
    })
    .transform((v) => {
      return {
  ...
  export type Outbound = {
    ...
    RawResponse: never;
    EncounterConditionValue?:
      | components.EncounterConditionValue$.Outbound
      | undefined;
  };
  ...
  > = z
    .object({
      ...
      encounterConditionValue:
        components.EncounterConditionValue$.outboundSchema.optional(),
    })
    .transform((v) => {
      return {
        ContentType: v.contentType,
