...
var ItemApiRequestFactory = (function (_super) {
    ...
    ItemApiRequestFactory.prototype.itemList = function (limit, offset, _options) {
        var _a, _b, _c;
    ...
    ItemApiRequestFactory.prototype.itemRead = function (id, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (id === null || id === undefined) {
                            throw new baseapi_1.RequiredError("ItemApi", "itemRead", "id");
                        }
                        localVarPath = '/api/v2/item/{id}/'
...
var ItemApiResponseProcessor = (function () {
    ...
    ItemApiResponseProcessor.prototype.itemListWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ItemApiResponseProcessor.prototype.itemReadWithHttpInfo = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, _j, _k;
            return __generator(this, function (_l) {
                switch (_l.label) {
